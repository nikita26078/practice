...
urlpatterns = [
    ...
    path('shipping/delete_shipping/<int:id>', views.shipping_delete_ship, name='shipping_delete_ship'),
    path('shipping/delete_order/<int:id>', views.shipping_delete_order, name='shipping_delete_order'),
    path('shipping/delete_item/<int:id>', views.shipping_delete_item, name='shipping_delete_item'),
